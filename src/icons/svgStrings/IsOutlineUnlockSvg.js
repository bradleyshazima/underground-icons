export const IsOutlineUnlockSvg  = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M6 10V8C6 4.69 7 2 12 2C16.5 2 18 4 18 7" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
